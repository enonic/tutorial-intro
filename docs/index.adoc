...
[TIP]
====
The command uses the https://market.enonic.com/vendors/enonic/intro[Intro^] app as a starter (template) for your app.
====
...
Select the `Sample Content` project when prompted, and you should now see the imported content.
...
+
* Internal path: `/site/intro/master`
* Public path: `/api`
