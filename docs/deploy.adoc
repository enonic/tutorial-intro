...
So far, you've been playing with the API via Content Studio. If you want to access the API endpoint directly on your sandbox, it's available at respectively:
