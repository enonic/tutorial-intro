...
WARNING: We are currently working to add support for XP8 to the Enonic Cloud. The steps will not work until we have completed this work. We will update this guide as soon as the support is available.
...
We will provision an Enonic XP environment, similar to your local sandbox, but this time on a real server.
...
Visit the https://developer.enonic.com/docs/cms[CMS reference documentation] to learn about content modeling and the CMS features.

For more details on Enonic app development and platform extensions, visit the  https://developer.enonic.com/docs/code[Enonic Development Kit documentation].

For hands on tutorials, visit the https://developer.enonic.com/docs/learn[Learn section].
