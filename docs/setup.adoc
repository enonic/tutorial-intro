...
A https://developer.enonic.com/docs/xp/stable/development/sandboxes[sandbox^] is a local development instance of the platform - Enonic XP. Create and start a sandbox called `mysandbox` by running this command in your terminal:
  ...
  enonic sandbox create mysandbox -v 7.16.5 -t essentials -f
...
The boot page provides an overview of the sandbox, including installed application, as well as the https://developer.enonic.com/docs/platform/xp7/deployment/config[standard configuration files^].
