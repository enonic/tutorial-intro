...
As you have now seen, XP lets you run server-side https://developer.enonic.com/docs/platform/xp7/framework[TypeScript and JavaScript code]. API augmentation is just the tip of the iceberg - believe us.
