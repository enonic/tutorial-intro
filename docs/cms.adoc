...
To edit an item, simply select it and click btn:[Edit] in the menu bar, or via right click. When editing a Person content item, this is what the content editor looks like, including a preview on the right hand side.
